...
• HDFC: hdfc-regalia-gold, hdfc-millenia-credit-card, hdfc-swiggy-credit-card, hdfc-freedom-credit-card, hdfc-indian-oil-credit-card, hdfc-diners-privilege-credit-card, hdfc-pixel-play-credit-card, hdfc-rupay-credit-card, hdfc-indigo-credit-card, HDFC-Moneyback-Credit-Card, shoppers-stop-black-hdfc-credit-card
• Axis: axis-bank-magnus-credit-card, axis-flipkart-credit-card, axis-privilege-amex-credit-card, axis-atlas-credit-card, axis-neo-credit-card, axis-bank-myzone-credit-card, axis-horizon-credit-card, axis-cashback-credit-card, axis-indian-oil-rupay-credit-card
• SBI: sbi-cashback-credit-card, sbi-elite-card, sbi-aurum-credit-card, sbi-simply-click-credit-card, sbi-bpcl-octane-credit-card, flipkart-sbi-credit-card, tata-neu-infinity-sbi-credit-card, irctc-sbi-platinum-card
• ICICI: icici-amazon-pay-credit-card, icici-sapphiro-credit-card, icici-hpcl-coral-credit-card, icici-rubyx-credit-card, icici-platinum-chip-credit-card, makemytrip-icici-signature
• Others: scapia-credit-card, idfc-first-millennia-credit-card, idfc-first-select-credit-card, au-altura-credit-card, au-altura-plus-credit-card, au-nomo-credit-card, zagg-rupay-credit-card, hsbc-travel-one, standard-charted-ultimate, amex-platinum-travel-credit-card, american-express-platinum-card
