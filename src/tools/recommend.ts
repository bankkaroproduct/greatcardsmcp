...
export const recommendCardsSchema = z.object({
  ...
  school_fees: z.number().optional().describe('Monthly school/education fees in ₹. INCLUDES: school tuition, coaching (Byju\'s, Unacademy), college fees, course fees paid on credit card'),
